...
- **frequency-aware and recency-aware reinforcement signals in retrieval ranking**
- **compact reinforcement rollups in search diagnostics, including per-bucket parity**
