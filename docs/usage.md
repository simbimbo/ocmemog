...
- `searchDiagnostics.reinforcement_rollup` and `searchDiagnostics.retrieval_reinforcement` now summarize visible reinforcement pressure and retrieval-side reinforcement totals, including per-bucket visible reinforcement counts.
