...
BRAIN_EMBED_MODEL_LOCAL = OCMEMOG_EMBED_MODEL_LOCAL or os.environ.get("BRAIN_EMBED_MODEL_LOCAL", "simple")
OCMEMOG_EMBED_MODEL_PROVIDER = os.environ.get("OCMEMOG_EMBED_MODEL_PROVIDER", "")
BRAIN_EMBED_MODEL_PROVIDER = OCMEMOG_EMBED_MODEL_PROVIDER or os.environ.get("BRAIN_EMBED_MODEL_PROVIDER", "")
